...
- **pressure** (*Optional*): The information for the pressure sensor. See :ref:`xdb401-converting`.
...
Calibrated
**********
1. Expose the sensor to a low known pressure, for example ``10`` kPa.
2. Observe the value of the raw pressure sensor, for example ``12`` kPa.
3. Expose the sensor to a high pressure, for example ``100`` kPa (=1 atm).
4. Observe the value of the raw pressure sensor, for example ``101.325`` kPa.
